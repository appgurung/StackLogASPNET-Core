...
namespace StackLog.Backend
{
    public interface IStackLogHost
    {
        ...
        Task <ApiResponse<IStackLogHostResponse>> LogCloudWatch(string bucketKey, [Header("secretKey")] string secretKey, [Header("stackKey")] string stackKey, [Body] StackLogExceptionInformation action);
